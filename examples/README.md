...
absolute URL of this checkout's `dist/index.js`, then place the configuration where OpenCode loads
...
The package root, `dist/index.js`, and `./opencode/v2` are current v2 entries. OpenCode `1.18.26`
